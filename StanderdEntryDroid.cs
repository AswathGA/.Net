...
[assembly: ExportRenderer(typeof(StandardEntry), typeof(StanderdEntryDroid))]
namespace Draftsy.Droid.Dependency
{
    public class StanderdEntryDroid : EntryRenderer
    {
        public StanderdEntryDroid(Context context) : base(context)
        {
        }
